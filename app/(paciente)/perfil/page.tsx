        ...
        <div className="min-h-screen bg-[#F8FAFC] pb-20">
            ...
            <div className="flex flex-col items-center -mt-16 mb-6 relative z-30">
                <div className="relative group">
                    ...
                    <div className="relative">
                        <img src="/images/avatar_sophia.png" className="w-24 h-24 rounded-full border-4 border-white shadow-xl object-cover" alt="Sophia" />
            ...
            <div className="px-4 space-y-4">
                <div className="text-center mb-2">
                    <h2 className="font-black text-[18px] text-[#1A365D]">{user?.nome ?? 'Sophia'}</h2>
                ...
                <div className="bg-white rounded-[20px] shadow-card border border-slate-100 overflow-hidden">
                    ...
                    {[
                        { icon: User, label: 'Nome', value: user?.nome ?? 'Sophia' },
                        { icon: Mail, label: 'E-mail', value: user?.email ?? 'sophia@email.com' },
