            ...
            {medico.sociais && (Object.keys(medico.sociais).length > 0) && (
                <div className="px-5 mb-8 pb-32"> {/* Added padding to not be covered by fixed CTA */}
                    ...
                    <div className="flex justify-center gap-4">
                        {medico.sociais.whatsapp && (
                            <button onClick={() => window.open(`https://wa.me/${medico.sociais?.whatsapp}`, '_blank')} className="bg-[#25D366] p-3 rounded-2xl text-white shadow-lg active:scale-90 transition-all">
                        ...
                        {medico.sociais.youtube && (
                            <button onClick={() => window.open(medico.sociais?.youtube, '_blank')} className="bg-[#FF0000] p-3 rounded-2xl text-white shadow-lg active:scale-90 transition-all">
