            ...
            <div className="flex flex-col h-screen overflow-hidden bg-[#E2E8F0]">
                ...
                <div className="flex flex-col h-screen relative z-10 overflow-hidden">
                    {isSearching ? (
                        ...
                        <>
                            <header className="bg-[#2D5284] px-3 py-3 flex items-center gap-2 text-white shadow-md z-20 shrink-0 relative rounded-b-[24px]">
                                <div className="flex flex-col items-center flex-1 pr-6">
                                    <span className="text-[12px] font-black tracking-widest text-white/60 mb-1">DocZap Criptografado</span>
                                    <div className="flex items-center gap-2">
                                        <ShieldCheck className="w-4 h-4 text-emerald-400" />
                                        <span className="font-bold text-[14px]">Conversa Segura</span>
                                    </div>
                                </div>
                            
                                <div className="flex items-center gap-4 text-white p-1">
                                    <Video className="w-[22px] h-[22px] cursor-pointer" onClick={() => toast.info('Videochamada...')} />
                                    <Phone className="w-[20px] h-[20px] cursor-pointer" onClick={() => toast.info('Chamada...')} />
                                    <div className="relative">
                                        <MoreVertical className="w-5 h-5 cursor-pointer" onClick={() => setIsMenuOpen(!isMenuOpen)} />
                                        {isMenuOpen && (
                            ...
                            <div className="bg-[#2D5284] px-4 pb-4 flex items-center gap-3 text-white rounded-b-[32px] shadow-lg -mt-[1px] relative z-10">
                                ...
                                <div className="flex items-center gap-3 flex-1 cursor-pointer" onClick={() => setShowContactProfile(true)}>
                                    <div className="w-12 h-12 rounded-2xl border-2 border-white/20 overflow-hidden shadow-md">
                                        <img src={chatAtivo.foto} className="w-full h-full object-cover" />
                                    </div>
                                    <div className="flex flex-col">
                                        <h2 className="font-bold text-[17px]">{chatAtivo.nome}</h2>
                                        <div className="flex items-center gap-1.5 leading-none mt-0.5">
                                            <div className={`w-2 h-2 rounded-full ${chatAtivo.online ? 'bg-emerald-400' : 'bg-slate-400'}`}></div>
                                            <span className="text-[12px] text-white/70">{chatAtivo.online ? 'Online' : 'Visto recentemente'}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="px-5 -mt-6 relative z-30 mb-8">
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="w-full bg-white rounded-2xl py-3 pl-12 pr-4 shadow-md outline-none" 
                    />
                </div>
            </div>
