...
export default function CestaPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#F1F5F9] to-[#E2E8F0] pb-32">
            {/* Header Padronizado */}
            <Header variant="page" title="Minha Cesta" showBackButton showNotifications userAvatar="/avatar-joce.png" userName="Joce Moreno" />
