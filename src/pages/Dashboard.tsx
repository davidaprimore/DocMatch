...
export function Dashboard() {
  ...
  // Bloqueio do botão voltar nativo para não sair do App por engano
  useEffect(() => {
    // Garante que a página atual está gravada para interceptarmos a saída
    window.history.pushState(null, '', window.location.href);

    const handlePopState = () => {
      // Re-adiciona o estado de forma silenciosa e repõe o history
      window.history.pushState(null, '', window.location.href);
    };
          ...
          {[
            {
              label: 'Agendar', desc: 'Consulta', icon: (
                <div className="relative w-full h-full flex flex-col items-center justify-center pt-2">
                  <img src="/icone-agenda.png.png" className="w-[56px] h-[56px] object-contain drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform -mt-2.5" alt="Agendar" />
