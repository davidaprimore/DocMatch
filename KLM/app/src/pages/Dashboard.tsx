...
export function Dashboard() {
  ...
  const medicosSugeridos = [
    { ...medicosMock[0], foto_url: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?q=80&w=150&auto=format&fit=crop', rating: 4.9, favorito: false }, // Dra. Ana Silva
    { ...medicosMock[3], foto_url: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?q=80&w=150&auto=format&fit=crop', rating: 4.8, favorito: true },  // Dr. André Santos
    { ...medicosMock[4], foto_url: 'https://images.unsplash.com/photo-1614608682850-e0d6ed316d47?q=80&w=150&auto=format&fit=crop', rating: 5.0, favorito: false }, // Dra. Fernanda Lima
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E2E8F0] to-[#F1F5F9] pb-20 font-sans">
      ...
      <header className="bg-[#2D5284] px-5 pt-5 pb-6 rounded-b-2xl shadow-md relative z-20">
      ...
      <main className="px-4 py-4 space-y-4">
        {/* Banner Econonia Pill - Arte Estilosa */}
        <div className="w-full bg-gradient-to-r from-[#CFAF42] via-[#E2C358] to-[#CFAF42] rounded-full py-[11px] flex items-center justify-center shadow-[0_8px_20px_rgba(207,175,66,0.3),inset_0_-2px_6px_rgba(0,0,0,0.1),inset_0_2px_4px_rgba(255,255,255,0.4)] mb-8 px-4 border border-[#E8C55E]/50">
        ...
        <div className="grid grid-cols-4 gap-3 mb-10 px-1 pt-2">
          {[
            {
              label: 'Agendar', desc: 'Consulta', icon: (
                <div className="relative w-full h-full flex flex-col items-center justify-center pt-2">
                  <img src="/icone-agenda.png.png" className="w-[56px] h-[56px] object-contain drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform" alt="Agendar" />
            ...
            { label: 'Minhas', desc: 'Receitas', icon: <img src="/icone-receitas.png.png" className="w-[56px] h-[56px] object-contain drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform" alt="Receitas" /> },
            { label: 'Comparador', desc: 'de Preços', icon: <img src="/icone-balanca.png.png" className="w-[56px] h-[56px] object-contain drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform" alt="Comparador" /> },
            { label: 'Minha', desc: 'Cesta', icon: <img src="/icone-cesta.png.png" className="w-[56px] h-[56px] object-contain drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)] hover:scale-105 transition-transform" alt="Cesta" /> },
          ].map((item, i) => (
            <div key={i} className="flex flex-col items-center">
              <button
                onClick={() => i === 0 ? navigate('/agendar') : null}
        ...
        <section className="mb-8">
          <div className="flex justify-between items-baseline mb-2">
            ...
            <button className="text-[11px] font-bold text-[#2D5284] hover:underline">Mostrar todos</button>
          </div>
            ...
            {medicosSugeridos.map((medico, index) => (
              ...
              >
                <div className="relative mb-3 w-full">
                  <img
                    src={medico.foto_url}
                    className="w-full aspect-square rounded-[22px] object-cover shadow-[0_12px_24px_-6px_rgba(0,0,0,0.15)] border border-slate-100/50"
                    alt={medico.nome}
                  />
                  <button
                    className={`absolute -top-2 -right-2 w-[34px] h-[34px] rounded-full flex items-center justify-center shadow-[0_4px_12px_rgba(0,0,0,0.08),inset_0_1px_1px_rgba(255,255,255,0.8)] border border-white/60 ${medico.favorito
                      ? 'bg-gradient-to-b from-[#FEF2F2] to-[#FEE2E2]'
                      : 'bg-gradient-to-b from-white to-gray-50'
                      }`}
                  >
                    <Heart
                      className={`w-[16px] h-[16px] transition-colors ${medico.favorito
                ...
                <p className="text-[13px] font-bold text-left text-[#1A365D] leading-tight w-full truncate">
                  {medico.nome}
                </p>
                <p className="text-[10px] text-slate-500 font-medium text-left mt-0.5 w-full truncate">
